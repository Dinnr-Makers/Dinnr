...
context 'user signed in and on the home page' do
  ...
  xit 'should not show a join event link on the home page if the user has already signed up' do
    visit '/'
    user_one_create_event
    click_link("Sign out", match: :first)
    user_two_sign_up
...
context 'user signed in and on an event page' do
  ...
  it 'should not show a join event link if the user has already signed up' do
    ...
    xit 'should not show a join event link if the user has created the event' do
    visit '/'
    user_one_create_event
    click_link "Dinner with Thomas"
    expect(page).not_to have_link('Join Event')
